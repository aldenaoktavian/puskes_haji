...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/galeri.css?crc=3811099586" id="pagesheet"/>
<div class="container-fluid bg-white-full">
	<div class="row main-width">
					...
					<ul class="profil-list">
						<li>
							<div class="Teks_link Teks_link--16 clearfix grpelem" id="u7488-4"><!-- content -->
								<a href="<?php echo base_url(); ?>galeri/foto" class="<?php echo ($url_type == 'list-berita' ? 'active' : ''); ?>">Foto</a>
							</div>
						</li>
						<li>
							<div class="Teks_link Teks_link--16 clearfix grpelem" id="u7488-4"><!-- content -->
								<a href="<?php echo base_url(); ?>galeri/video" class="<?php echo ($url_type == 'laporan-kerja' ? 'active' : ''); ?>">Video</a>
							</div>
						</li>
					</ul>
				</div>
		...
		<div class="col-md-8">
			<div class="Heading-2--32px clearfix colelem" id="u5020-4"><!-- content -->
        		<?php echo $sub_title; ?>
       		</div>
       		<div class="colelem" id="u5021"><!-- simple frame --></div>
       		<div class="clearfix"></div>
			<?php echo $load_galeri_type; ?>
		</div>
	</div>
</div>
